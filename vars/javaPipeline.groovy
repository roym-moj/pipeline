...
//            }
            ...
            stage('Package') {
                steps {
                    ...
                    sh "docker tag ${env.JOB_NAME}:latest ${AWS_ACCOUNT_ID}.dkr.ecr.us-east-2.amazonaws.com/demo:${env.JOB_NAME}"
                }
            }
            ...
            stage('Publish') {
                steps {
                    ...
                    sh "docker push ${AWS_ACCOUNT_ID}.dkr.ecr.us-east-2.amazonaws.com/demo:${env.JOB_NAME}"
                }
            }
